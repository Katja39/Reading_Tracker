...
class _BookDetailPageState extends State<BookDetailPage> {
  ...
  Future<void> _showEditDialog() async {
    ...
    final localUpdatedBook = Book(
      ...
      howAcquired: _book.howAcquired,
      whereAcquired: _book.whereAcquired,
      authorOriginId: _book.authorOriginId,
      authorGender: _book.authorGender,
      acquiredOn: _book.acquiredOn,
      price: _book.price,
      notes: _book.notes,
      totalReadingMinutes: _book.totalReadingMinutes,
